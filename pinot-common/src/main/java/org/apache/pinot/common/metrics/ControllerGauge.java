...
public enum ControllerGauge implements AbstractMetrics.Gauge {
  ...
  NUM_MINION_SUBTASKS_WAITING("NumMinionSubtasksWaiting", false),
  MAX_SUBTASK_WAIT_TIME_MS("MaxSubtaskWaitTimeMs", false),
  NUM_MINION_SUBTASKS_RUNNING("NumMinionSubtasksRunning", false),
  MAX_SUBTASK_RUNNING_TIME_MS("MaxSubtaskRunningTimeMs", false),
  NUM_MINION_SUBTASKS_ERROR("NumMinionSubtasksError", false),
  NUM_MINION_SUBTASKS_UNKNOWN("NumMinionSubtasksUnknown", false),
  NUM_MINION_SUBTASKS_DROPPED("NumMinionSubtasksDropped", false),
  NUM_MINION_SUBTASKS_TIMED_OUT("NumMinionSubtasksTimedOut", false),
  NUM_MINION_SUBTASKS_ABORTED("NumMinionSubtasksAborted", false),
  PERCENT_MINION_SUBTASKS_IN_QUEUE("PercentMinionSubtasksInQueue", false),
  PERCENT_MINION_SUBTASKS_IN_ERROR("PercentMinionSubtasksInError", false),
